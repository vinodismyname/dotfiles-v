...
run_with_spinner "Installing latest nvidia-container-toolkit" "sudo yum install -y nvidia-container-toolkit &>/dev/null"
run_with_spinner "Enabling graphics again" "sudo yum-config-manager --enable amzn2-graphics &>/dev/null"
run_with_spinner "Enabling graphics again" "sudo yum-config-manager --enable amzn2-graphics &>/dev/null"
